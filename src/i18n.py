...
UI: dict[Lang, dict[str, str]] = {
    "en": {
        ...
        "upload_dialog_hint": "Picker didn't open? Click Upload once more — some browsers need a second click.",
    ...
    "fr": {
        ...
        "upload_dialog_hint": "La fenêtre ne s'ouvre pas ? Cliquez à nouveau sur Upload — certains navigateurs ont besoin d'un second clic.",
