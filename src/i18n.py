...
UI: dict[Lang, dict[str, str]] = {
    "en": {
        ...
        "style_preview_heading": "**Live preview**",
        "style_preview_doc_label": "Preview document",
        "style_preview_doc_cv": "CV",
        "style_preview_doc_letter": "Cover Letter",
        "style_preview_sample_caption": "Showing a sample document — generate your own in the \"Input\" tab to preview it here instead.",
    ...
    "fr": {
        ...
        "style_preview_heading": "**Aperçu en direct**",
        "style_preview_doc_label": "Document à prévisualiser",
        "style_preview_doc_cv": "CV",
        "style_preview_doc_letter": "Lettre de motivation",
        "style_preview_sample_caption": "Document d'exemple affiché — générez le vôtre dans l'onglet « Entrée » pour le prévisualiser ici.",
        "results_subtab_cv": "CV",
